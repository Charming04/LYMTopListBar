...
- (void)viewDidLoad {
    ...
    mb_topbar = [[LYM_TopListBar alloc]initWithFrame:CGRectMake(0, 20, self.view.frame.size.width, 40) itemTitle:titlesArr relScrollView:mb_relscrollV];
...
//    //以下三个回调代码实现关联滑动（如果不做关联滑动的话，不需要实现下面的回调方法）
    ...
    [mb_relscrollV didEndScroll:^(int position) {
